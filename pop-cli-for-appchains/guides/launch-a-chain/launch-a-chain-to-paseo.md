...
If you want to test onboarding a chain on your local machine you need to [launch Paseo](./spinning-up-paseo.md).
...
> Note: the `--url ws://localhost:57731` parameter should point to a [Paseo Local node](./spinning-up-paseo.md#network-endpoints).
