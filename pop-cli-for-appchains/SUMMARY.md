...
* [Build a Polkadot Chain](README.md)

***

* [Install Pop CLI](install-pop-cli.md)
...
* [Start a frontend dev server](guides/pop-up-frontend.md)
* [Test runtime upgrades](guides/test-runtime-upgrades.md)
  * [Test execute-block](guides/test-execute-block.md)
  * [Test fast-forward](guides/test-fast-forward.md)
* [Upgrade Polkadot SDK dependencies](guides/upgrade-polkadot-sdk.md)
* [Benchmarking](guides/benchmarking/README.md)
  * [Benchmark pallets and extrinsics](guides/benchmarking/benchmarking-pallets-and-extrinsics.md)
  * [Benchmarking subcommands](guides/benchmarking/bench-subcommands.md)
* [Deploy a chain](guides/launch-a-chain/README.md)
  * [Deploy a chain with pop up](guides/launch-a-chain/launch-a-chain-with-pop-up.md)
  * [Launch a local development network](guides/launch-a-chain/running-your-chain.md)
  * [Launch a known chain locally](guides/launch-a-chain/launch-a-known-chain.md)
  * [Deploy a chain to Paseo](guides/launch-a-chain/launch-a-chain-to-paseo.md)
