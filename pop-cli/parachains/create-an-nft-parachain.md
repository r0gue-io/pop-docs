# Create an NFT parachain

To create an NFT parachain with Pop CLI

```
pop new parachain my-nft-chain pop -t assets
```

Additional configurations are availble.

```
pop new parachian --help
