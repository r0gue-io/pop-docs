...
To run end-to-end (e2e) tests, for which you need a chain running:

```bash
pop test --e2e
```

If you want to run your e2e tests on your own local chain specify the directory path using:
